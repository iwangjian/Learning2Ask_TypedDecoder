...
def build_vocab(path, data):
    ...
    if FLAGS.question_data:
        ...
        vocab_list = START_VOCAB + question_words + sorted(vocab, key=vocab.get, reverse=True)
    ...
    vectors = {}
    with open('%s/wordvec' % FLAGS.data_dir) as f: #you should set your word to vector path here
